...
<header>
  ...
  ?>
	...
	echo'<li class="Logowanie1"><a href="showzamowienie.php">Status zamówienia</a></li>';
	
		
	echo'<li class="Logowanie2"><a href="wyswietlanie_koszyka.php">Przejdź do koszyka</a></li>';
	echo'<li class="Logowanie3"><a href="index.php">Przejdż do sklepu</a></li>';
