...
<?php
	...
	function add($ilosc3,$idee3)
	{
		...
		$zapytanie="insert into koszyk(id,id_uzytkownika,product_id,ilosc_produktow,data) values(null,$id_uzytkownika,$idee3,$ilosc3,NOW())";
		$sql=mysqli_query($link,$zapytanie) or die ("Żle sformułowane zadanie danych");
		$zapytanie2 = "update produkty set ilosc=ilosc-$ilosc3 where id=$idee3";
