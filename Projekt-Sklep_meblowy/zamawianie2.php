...
function dodawanieZamowienia($id_prod,$ilosc,$cena,$imie,$nazwisko,$miasto,$ulica)
{
	...
	$data=date("Y-m-d H:i:s");
		...
		$zapytanie2 = "INSERT INTO `zamowienia` (`id`, `id_uzytkownika`, `id_towaru`, `data`, `name`, `surname`, `adress`, `miasto`, `ilosc`, `cena`) VALUES ('null', '$id_uzytkownika', '$id_prod', '$data', '$imie', '$nazwisko', '$ulica', '$miasto', '$ilosc', '$cena')";
